...
const Login = ({ onLogin }) => {
  ...
  const handleLogin = async () => {
    try {
      ...
      const response = await axios.post("http://findopendentist.onrender.com/login", { email, password });
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await axios.post("http://findopendentist.onrender.com/forgot-password", { email });
